      ...
      {isSingle ? (
        ...
        <div className="auth-glass-container">
          ...
          <div className="auth-glass-left">
            ...
            <div style={{ color: '#16A34A', fontSize: '12px', margin: '15px 0' }}>â™¡</div>
            <p className="auth-glass-tagline">Homemade Taste.<br/>Made with <span style={{color: '#16A34A'}}>Love.</span></p>
          </div>
          
          {/* Right Side Form */}
          <div className="auth-glass-right">
            <div className="auth-glass-header">
              <p className="auth-welcome" style={{ color: '#16A34A' }}>Welcome Back!</p>
